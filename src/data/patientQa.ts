...
export const LIN_XIULAN_STARTER_QA: PresetQA[] = [
  ...
  qa('lin-lower-limb', '下肢康复训练具体该怎么做？',
    [['下肢', '训练'], ['下肢', '康复'], ['下肢', '怎么做'], ['腿', '锻炼']], ['林秀兰的下肢康复训练计划', '下肢康复训练视频'],
    ['下肢训练应循序渐进，动作以能够稳定、完整完成为准，训练中保持自然呼吸、避免屏气，也不要借助下肢以外的方式猛然发力替代。', '训练应由家属或照护者在旁保护；出现头晕、心慌、明显疲劳或不适立即停止。'],
    ['林秀兰的下肢训练以脚踝和足部活动、小腿放松为主，按今日安排里的次数和时长执行即可。', '想要复习标准动作，可以点击下方「播放训练视频」查看完整的下肢康复训练演示，对照着做更容易到位。'], false, undefined, 'v-balance'),
]
