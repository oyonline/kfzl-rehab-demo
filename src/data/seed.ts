...
export const videos: VideoAsset[] = [
  ...
  { id: 'v-dress-1',      title: '穿脱衣物（一）', category: '肢体康复类',   src: '/videos/v-dress-1.mp4',      durationSec: 141, origin: 'team_reviewed' },
  { id: 'v-dress-2',      title: '穿脱衣物（二）', category: '肢体康复类',   src: '/videos/v-dress-2.mp4',      durationSec: 84,  origin: 'team_reviewed' },
